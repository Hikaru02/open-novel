...
READY('MODEL', 'DOM').then(function () {
	...
	METHODS = {
		COMMON: {
			...
			showNotice: function (message, show_time, delay_time) {
				if (!message) throw 'illegal message string'
				show_time  = +show_time  || 3000
				delay_time = +delay_time || 500
			...
			setLoadingMessage: function (message) {
				...
				defer.promise.then(function () {
					el_player.append(loadingWindow).append(new DOM('pre', {margin: '0%'})).append(new DOM('text', message))
				})
